...
import com.neuralnexusstudios.nexremote.core.network.CryptoUtils
...
class CryptoUtilsTest {
    ...
    fun builtInLayouts_serializeAndDeserialize() {
        ...
        val decoded = json.decodeFromString<List<com.neuralnexusstudios.nexremote.core.model.GamepadLayoutConfig>>(encoded)
